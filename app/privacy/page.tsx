  ...
  return (
    <main className="min-h-[100dvh] bg-black text-white">
      <div className="mx-auto w-full max-w-2xl px-4 py-10">
        <h1 className="mb-6 text-2xl font-extrabold tracking-wide">
          プライバシーポリシー
        </h1>
        ...
        <section className="space-y-6 text-sm leading-[1.9]">
          ...
          <div>
            ...
            <ul className="list-inside list-disc space-y-1 opacity-90">
              <li>
                アクセスログ情報（IPアドレス、User-Agent、閲覧URL、リファラー、アクセス日時
                など）
              </li>
              <li>
          ...
          <div>
            ...
            <p className="opacity-90">
              ...
              Cookie や同等の技術を使用します。ブラウザ設定により Cookie
              を無効化できますが、
