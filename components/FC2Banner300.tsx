...
export default function FC2Banner300() {
  ...
  // ★ 自サイト経由のプロキシ URL に変換（Safari でのブロック回避）
  ...
  return (
    <div className="grid place-items-center py-2">
      <div className="rounded-xl border border-white/10 bg-white/5 p-3" style={{ width: "100%", maxWidth: 340 }}>
        {imgOk ? (
          <a
            href={href}
            target="_blank"
